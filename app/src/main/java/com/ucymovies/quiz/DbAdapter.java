...
public class DbAdapter extends SQLiteOpenHelper implements DBInfo{
	...
	private void populateTables(SQLiteDatabase db){
		populateMovies(db);
		populateStars(db);
		populateStarsInMovies(db);
	}

	private void populateMovies(SQLiteDatabase db){
		try {
	...
	private void populateStars(SQLiteDatabase db){
		try {
			BufferedReader in = new BufferedReader(new InputStreamReader(
	...
	private void populateStarsInMovies(SQLiteDatabase db){
		try {
			BufferedReader in = new BufferedReader(new InputStreamReader(
